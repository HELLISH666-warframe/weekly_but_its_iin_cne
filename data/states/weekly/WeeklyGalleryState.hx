...

{
    ...
    //        for(i in allFiles) if(StringTools.endsWith(i,'.png') && !i.contains("button") && !i.contains(".txt")) images.push(i);
            ...
            for(image in images){
               ...
               // var txtvers = Paths.file('images/gallery/weeks/' + folder + '/' + image +  ''.replace(".png", ".txt"));
                var txtvers = Paths.file('images/gallery/weeks/' + folder + '/' + image +  ''.split(".png", ".txt"));
