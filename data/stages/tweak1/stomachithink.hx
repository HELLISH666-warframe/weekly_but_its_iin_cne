...
function create() 
{
    ...
    bg = new FlxSprite(120, -50).loadGraphic(Paths.image('stages/johnBG'));
...
function postCreate()
{
    ...
    extraGuy1 = new Character(dad.x, dad.y, 'john', false);
    extraGuy1.flipX = false;
    add(extraGuy1);

    extraGuy2 = new Character(dad.x, dad.y, 'john', false);
...
//    comboOffsetCustom = [150, 300, 185, 450];
